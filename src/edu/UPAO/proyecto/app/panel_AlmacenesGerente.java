...
public panel_AlmacenesGerente() {
        ...
        // --- CORRECCIÓN: AHORA LO PONEMOS EN jPanel5 (Pestaña "INVENTARIO") ---
        
        // 1. Le damos diseño de Bordes para que se estire completo
        jPanel1.setLayout(new java.awt.BorderLayout()); 
        
        // 2. Agregamos el panel bonito (PanelInventarioGlobal) dentro de jPanel5
        jPanel1.add(new PanelInventarioGlobal(), java.awt.BorderLayout.CENTER);
